...
class network():
    ...
    Methods:
        ...
        __rotate_image: Rotates an image.
    ...
    def __rotate_image(self, name):
        """
        Rotates an image.

        Args:
            name (str): The filename of the image to rotate
        """
    ...
    def __recieve(self):
        """
        Receives a message from the server and returns the decoded message.
